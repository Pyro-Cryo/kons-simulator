...
export class BusyMetadata {
   ...
   */
  constructor(actionDescription = null, startedAt = null, endsAt = null) {
...
export class NPC extends GameObject {
  ...
  async setBusyFor(gameMinutes, description = null) {
    ...
    this.busyMetadata = new BusyMetadata(
      description,
      Clock.now(),
      Clock.after(gameMinutes)
    );
  ...
  pickUp(item) {
    ...
    const containedBy =
      item.maybeGetInterface(Containable)?.containedBy ?? null;
    if (containedBy !== null) {
