...
class Hunger extends FurnaceVariable {
  ...
  static get description() {
    return 'Personens behov att äta';
  }
...
class Temperature extends Variable {
  ...
  static get description() {
    return 'Hur varmt något eller någon är';
  }
  static get unit() {
    return ' \u00b0C';
  }
   ...
   *    between the item and the environment is halved.
   * @param {number|null} environment Temperature of the surrounding
   *    environment.
   * @param {number|null} initial Initial temperature of this item. Defaults to
